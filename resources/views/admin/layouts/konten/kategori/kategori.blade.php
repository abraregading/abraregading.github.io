        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                  <a href="/kategori/create" class="btn btn-sm btn-primary sm-3">Tambah Data</a>
                  @if (session('pesan'))
                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td>{{ $data->kt }}</td>
                    <td width="120">
                        <a href="/kategori/{{ $data->id }}/edit" class="btn btn-sm btn-info">Edit</a>
...
<div class="modal fade" id="hapus{{ $data->id }}">
    <div class="modal-dialog modal-sm">
        ...
        <div class="modal-header">
            <h4 class="modal-title">{{ $data->kt }}</h4>
