          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Tabel Dafar Proyek</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  <a href="/proyek/create" class="btn btn-sm btn-primary sm-3">Tambah Data</a>
                  @if (session('pesan'))
                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td>{{ $data->judul }}</td>
                    <td width="120">
                        <a href="/proyek/{{ $data->id }}/edit" class="btn btn-sm btn-info">Edit</a>
